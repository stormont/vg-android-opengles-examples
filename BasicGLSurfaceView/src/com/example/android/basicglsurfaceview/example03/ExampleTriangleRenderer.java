...
package com.example.android.basicglsurfaceview.example03;
...
public class ExampleTriangleRenderer implements Renderer {
    ...
    private final float[] TEMP_VERTICES_DATA = {
			...
			// Front face         // Front face          // Front face (red)
			...
			// Right face	      // Right face 	     // Right face (green)
			...
			// Back face	      // Back face 	     // Back face (blue)
			...
			// Left face	      // Left face 	     // Left face (yellow)
			...
			// Top face	      // Top face 	     // Top face (cyan)
			...
			// Bottom face	      // Bottom face 	     // Bottom face (magenta)
    ...
    public ExampleTriangleRenderer(final Context context) {
        ...
        mTriangleBuffer = new ColoredNormalTriangleBuffer(TEMP_VERTICES_DATA);
