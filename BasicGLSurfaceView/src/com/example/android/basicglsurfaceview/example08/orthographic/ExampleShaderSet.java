package com.example.android.basicglsurfaceview.example08.orthographic;
...
public class ExampleShaderSet extends ShaderSet {
	...
	public void render(final ICamera camera, final IRenderableBuffer buffer, final float[] modelMatrix, final float[] lightPosInEyeSpace) {
        ...
        GLES20.glUniformMatrix4fv(mModelViewHandle, 1, false, modelMatrix, 0);
        Matrix.multiplyMM(mat, 0, camera.projectionMatrix(), 0, modelMatrix, 0);
